	...
	$.fn.kinMaxShow = function(user_options){
			...
			var default_options = {
						...
						button:{
								...
								normal:{width:'30px',height:'6px',lineHeight:'6px',right:'250px',bottom:'20px',fontSize:'0px',background:"#ffffff",border:"0px solid #ffffff",color:"#666666",textAlign:'center',marginRight:'8px',fontFamily:"Verdana",float:'left'},
								//当前 按钮样式
								focus:{background:"#0fac48",border:"0px solid #FF0000",color:"#000000"}
							},
